  ...
  isLoading;
	...
	initializeForm() {
		this.userForm = this.fb.group({
			...
			phone_no: [{ value: this.profileData.phone_no, disabled: true }, [Validators.required]],
...
//-------------------------- change ASIMS password-----------------
	...
	onResetPasswordSubmit() {
		...
		if (this.changePasswordForm.valid) {
			...
			this.userService.updateUserPassword({currentPassword: current_password, newPassword: new_password}).subscribe(
				(data: any) => {					
				if (data) {
